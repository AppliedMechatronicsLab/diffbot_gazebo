...
def generate_launch_description():
    # Directories
    # pkg_diffbot_gazebo = get_package_share_directory(
    #     'diffbot_gazebo')
    ...
    ignition_launch = PathJoinSubstitution(
        [pkg_diffbot_gazebo, 'launch', 'robot.launch.py'])
    ...
    ignition = IncludeLaunchDescription(
        ...
        launch_arguments=[
            ('world', '/home/hath/ROS2/2024_NCKH_project/project_AI_robot/src/diffbot_gazebo/worlds/turtlebot3_world.world'),
